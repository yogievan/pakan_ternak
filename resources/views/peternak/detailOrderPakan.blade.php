...
@section('konten')
    <div class="w-[1027px]">
        <div class="mb-5">
            <a href="/order/pakan">
                <button class="bg-red-600 text-white p-1 rounded w-[100px] hover:bg-transparent hover:text-red-600 hover:border hover:border-red-600">Back</button>
            </a>
        </div>
        <form action="#" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="qty" class="w-full text-[1em] bg-gray-50 border border-gray-900 text-gray-900 rounded-lg p-3" placeholder="Nominal" required>
