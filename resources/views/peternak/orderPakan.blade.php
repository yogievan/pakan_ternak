        ...
        @foreach ($pakans as $item)
            <div class="bg-white shadow border rounded w-full mb-3 p-3">
                <div class="list-pakan">
                    <div class="w-[200px]">
                        <img class="pakan-img rounded border border-gray-400" src="../assets/img/pakan.jpg" alt="foto_produk">
                    </div>
                    ...
                    <div class="w-[200px] m-auto">
                        <a href="/order/pakan-{{ $item -> id }}">
                            <button type="submit" class="bg-slate-900 text-white p-3 rounded w-[200px] hover:bg-white hover:text-gray-900 hover:border hover:border-gray-900">Order</button>
                        </a>
